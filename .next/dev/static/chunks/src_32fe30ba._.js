...
const translations = {
    rw: {
        ...
        addPropertySubtitle: 'Ongeramo inyubako yawe kuri Afri Estate ukore ubukode bworoshye',
        addPropertyButton: 'Ongeramo Inyubako',
        addPropertyAlert: 'Ongeramo Inyubako',
        addPropertyAlertMessage: 'Kugira ngo wongeramo inyubako, ugomba kujya kuri website ya Afri Estate cyangwa ukoreshe dashboard ya landlord.',
        goToDashboard: 'Jya kuri Dashibodi',
        dashboardInfo: 'Jya kuri Dashibodi kugira ngo ukoreshe amahitamo yo kongeramo inyubako.',
        appFooter: 'Afri Estate © 2025 — "Ubukode bworoshye, ubuzima bwiza."',
    ...
    en: {
        ...
        addPropertySubtitle: 'Add your property to Afri Estate and make easy rentals',
        addPropertyButton: 'Add Property',
        addPropertyAlert: 'Add Property',
        addPropertyAlertMessage: 'To add a property, you need to go to the Afri Estate website or use the landlord dashboard.',
        goToDashboard: 'Go to Dashboard',
        dashboardInfo: 'Go to Dashboard to use the property addition options.',
        appFooter: 'Afri Estate © 2025 — "Easy rentals, better life."',
...
const useTranslation = ()=>{
    _s();
    const [currentLanguage, setCurrentLanguage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('rw');
    const t = (key)=>{
...
_s(useTranslation, "nlTEfaVxwmk5lPkwvMhBP2UC2nk=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
const LanguageProvider = ({ children })=>{
    _s1();
    const [currentLanguage, setCurrentLanguage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('en') // Default to English
    ;
    const [isLanguageLoaded, setIsLanguageLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Load saved language preference on app start (client-side only)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LanguageProvider.useEffect": ()=>{
            const loadLanguagePreference = {
                "LanguageProvider.useEffect.loadLanguagePreference": ()=>{
    ...
    const t = (key)=>{
        const translation = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["translations"][currentLanguage][key] || key;
...
_s1(LanguageProvider, "2WDrFK3qPfukqWpAjMWZBTth4/A=");
_c = LanguageProvider;
var _c;
...
const supabaseUrl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_SUPABASE_URL || 'https://sgektsymnqkyqcethveh.supabase.co';
const supabaseAnonKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNnZWt0c3ltbnFreXFjZXRodmVoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTAyNjk2MjEsImV4cCI6MjA2NTg0NTYyMX0.9-GgphRm5dMkmuXmBzu2cORM50qj4bLJdngAqDpjErU';
...
const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl, supabaseAnonKey, {
    auth: {
        storage: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2d$browser$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["localStorageAdapter"],
...
const queries = {
    // Properties
    getProperties: (userId)=>supabase.from('properties').select('*').eq('landlord_id', userId).order('created_at', {
            ascending: false
        }),
    // Rooms - Use RPC function to avoid RLS issues
    getRooms: (propertyId)=>supabase.rpc('get_property_rooms', {
            p_property_id: propertyId
        }),
    // Tenants
    getTenants: (propertyId)=>supabase.from('tenants').select(`
        *,
        room_tenants!inner(
          room_id,
          rent_portion,
      ...
      `).eq('room_tenants.rooms.property_id', propertyId).eq('room_tenants.is_active', true),
    // Payments
    getPayments: (propertyId, startDate, endDate)=>{
      ...
      `).eq('rooms.property_id', propertyId).order('payment_date', {
            ascending: false
        });
        if (startDate) {
...
const webUtils = {
    ...
    testConnectivity: async ()=>{
        try {
            ...
            console.log('🔍 [WEB] Environment variables loaded:', !!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_SUPABASE_URL);
            ...
            if (error) {
                ...
                if (error.code === '42501' || error.message?.includes('policy')) {
                    ...
                    return {
                        success: true,
                        note: 'Network working, RLS policy triggered'
                    };
                }
                return {
                    success: false,
    ...
    retryRequest: async (requestFn, maxRetries = 3, delay = 1000)=>{
        for(let i = 0; i < maxRetries; i++){
            try {
                ...
                console.log(`🔄 [WEB] Retry ${i + 1}/${maxRetries} failed:`, error.message);
...
"[project]/src/lib/roleGuard.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const hasRoleAccess = (userRole, screenName)=>{
...
const getCurrentUserRole = async ()=>{
    try {
        ...
        const { data: userData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('role, full_name').eq('id', user.id).single();
        if (error) {
...
const getCurrentUserProfile = async ()=>{
    try {
        ...
        if (role === 'tenant') {
            ...
            const { data: userRecord } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('*').eq('id', user.id).single();
            userData = userRecord;
        }
        if (!userData) {
            return null;
...
const checkScreenAccess = async (screenName)=>{
...
function Navigation() {
    ...
    const { t, currentLanguage, changeLanguage } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$languageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLanguage"])();
    const { theme, setTheme } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$themes$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"])();
    const [userRole, setUserRole] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('guest');
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Navigation.useEffect": ()=>{
            if (user) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$roleGuard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCurrentUserRole"])().then(setUserRole);
            } else {
                setUserRole('guest');
            }
        }
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                children: currentLanguage === 'rw' ? '🇷🇼 RW' : '🇺🇸 EN'
                            }, void 0, false, {
                                fileName: "[project]/src/components/navigation.tsx",
                                lineNumber: 111,
                                columnNumber: 11
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                className: "lg:hidden fixed top-0 left-0 right-0 z-40 border-b bg-background",
...
_s(Navigation, "mazbsdEVXJ/JcV4JjC6z/C6fSkA=", false, function() {
    return [
...
//# sourceMappingURL=src_32fe30ba._.js.map